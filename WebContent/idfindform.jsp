...
<head>
    ...
    <link rel="stylesheet" href="css/wheel.css">
    <link href="css/idfind.css" rel="stylesheet" type="text/css">
...
<form name=MyForm method="post" action="idfind.jsp">
      <div id="container">
        <div id="loginForm">
               <div id="m_l">아이디 찾기</div>
            <div id="login_1">
                <div id="id_text">이름</div>
                <input type=text name=user_name size=15 maxlength=10 style="font-size: 15px; background-color:transparent;border:0 solid black;text-align:left;">
