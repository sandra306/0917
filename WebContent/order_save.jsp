...
<%
 ...
 try {
  ...
  sql = "select max(id) from 20162422_saleorder";
  ...
  sql= "insert into 20162422_saleorder(id,name,orderdate,addr,phone," ;
  sql= sql + "pay,cardno,prodcount,total)" ; 
  sql= sql + " values("+id+",'"+wname+"','"+ymd+"','"+addr+"','"+phone  ;
  ...
  if (cnt >0) {
   for (int i=0; i< a.length ;i++) {
    ...
    price=rs.getInt(2);
    sql = "insert into 20162422_item(orderid,mynum,prodid,pname,quantity,price)" ;
